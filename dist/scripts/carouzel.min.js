...
d);a.o.effect===p[2]&&0>a.ci&&(a._t.nX=a.pts[a.sLen+a.ci]);a.o.effect===p[2]&&a.trk&&!a.fLoad&&J.fade(a)},fa=function(a){for(var d=null===window||void 0===window?void 0:window.innerWidth,b=a.bpall[0],c=0,e,k;c<a.bpall.length;){if(a.bpall[c+1]&&a.bpall[c+1].bp>d||"undefined"===typeof a.bpall[c+1]){b=a.bpall[c];break}c++}if(a.root&&!ba(a.root,a.o.editCls)&&(a.bpoOld||{})._2Show!==b._2Show&&a.trk){d=a.trk;c=b;k=d.querySelectorAll("."+(a.o.dupCls||""));for(e=0;e<k.length;e++)d.removeChild(k[e]);for(e=
c.pDups.length-1;0<=e;e--){k=d;var g=c.pDups[e],h=k.querySelectorAll("[data-carouzel-slide]")[0];h&&k.insertBefore(g,h)}for(e=0;e<c.nDups.length;e++)d.appendChild(c.nDups[e])}(a.bpoOld||{}).bp!==b.bp&&(a.bpo=b,a.bpoOld=b);if(a.nav){d=a.nav.querySelectorAll("[data-carouzel-dot]");for(c=0;c<d.length;c++)a.nav.removeChild(d[c]);for(c=0;c<b.dots.length;c++)a.nav.appendChild(b.dots[c])}!b._arrows&&a.ctrlW?x(a.ctrlW,a.o.hidCls):a.ctrlW&&C(a.ctrlW,a.o.hidCls);!b._nav&&a.navW?x(a.navW,a.o.hidCls):a.navW&&
C(a.navW,a.o.hidCls);a.fLoad&&a.o.rtl&&(a.ci=a.o.startAt=a.sLen-b._2Scroll);if(a.root&&a.trkW&&a.trkO&&a.trk){a.pts={};d=a.o.ver?(b.verH-(-b._2Show-1)*b.gutr)/(b._2Show+b.cntr):(a.trkW.clientWidth-(b._2Show-1)*b.gutr)/(b._2Show+b.cntr);a.sWid=d;e=a.sLen>=b._2Show?b.bpSLen:b._2Show;k=a.trkO.querySelectorAll("[data-carouzel-slide]");a._as=[];for(c=0;c<k.length;c++)a._as.push(k[c]);a.aLen=a._as.length;c=d*e+b.gutr*(e+1);a.o.ver?(a.trk.style.height=t(c)+"px",a.trkO.style.height=t(b._2Show*d+b.gutr*(b._2Show-
...
a.pauseClk=!1;T(a,!0)}))},ua=function(a,d){var b=0,c=0,e=!1,k=0,g=0,h=0,l=0,q=0,w=0,B=0,y=0,D=0,L=0,M=0,E=!1,U=a.o.threshold||125,V=function(f){e=!0;"touchstart"===f.type?(L=f.changedTouches[0].screenX,M=f.changedTouches[0].screenY,l=f.changedTouches[0].screenX,w=f.changedTouches[0].screenY):(L=f.clientX,M=f.clientY,l=f.clientX,w=f.clientY)},W=function(f){if(e){"touchmove"===f.type?(k=f.changedTouches[0].screenX,g=f.changedTouches[0].screenY,q=l-f.changedTouches[0].screenX,B=w-f.changedTouches[0].screenY):
(k=f.clientX,g=f.clientY,q=l-f.clientX,B=w-f.clientY);b=k-L;c=g-M;y=Math.abs(b/c);D=Math.abs(c/b);a.ct||(a.ct=-a.pts[a.ci]);if(a.trk&&(a.o.effect===p[0]||a.o.effect===p[1])){if(y>D&&!a.o.ver&&(a.trk.style.transform="translate3d(".concat(a.ct-q,"px, 0, 0px)"),a.o.effect===p[1])){for(f=0;f<a.aLen;f++)a._as[f].style.transform="translate3d(0, 0, 5px)";for(f=a.ci;f<a.ci+a.bpo._2Show;f++)a._as[f+a.bpo._2Show]&&(a._as[f+a.bpo._2Show].style.transform="translate3d(".concat(q,"px, 0, 3px)"))}if(y<D&&a.o.ver&&
(a.trk.style.transform="translate3d(0, ".concat(a.ct-B,"px, 0)"),a.o.effect===p[1])){for(f=0;f<a.aLen;f++)a._as[f].style.transform="translate3d(0, 0, 5px)";for(f=a.ci;f<a.ci+a.bpo._2Show;f++)a._as[f+a.bpo._2Show]&&(a._as[f+a.bpo._2Show].style.transform="translate3d(0, ".concat(q,"px, 3px)"))}}if(a.trk&&a.o.effect===p[2])for(f=0;f<a.aLen;f++)a._as[f].style.opacity="1";h=a.o.ver?B:q}},P=function(f){if(e&&a.trk){"touchend"===f.type?(k=f.changedTouches[0].screenX,g=f.changedTouches[0].screenY):(k=f.clientX,
g=f.clientY);b=k-L;c=g-M;y=Math.abs(b/c);D=Math.abs(c/b);if(!isNaN(y)&&!isNaN(D)&&Infinity!==D&&Infinity!==y&&y!==D){E=!1;a.o.inf||(0<(a.o.ver?c:b)?0>=Math.abs(a.ct)?a.trk.style.transform=a.o.ver?"translate3d(0, ".concat(a.ct,"px, 0)"):"translate3d(".concat(a.ct,"px, 0, 0)"):E=!0:0>(a.o.ver?c:b)&&(Math.abs(a.ct)+a.sWid*a.bpo._2Show>=a.sWid*a.aLen?a.trk.style.transform=a.o.ver?"translate3d(0, ".concat(a.ct,"px, 0)"):"translate3d(".concat(a.ct,"px, 0, 0)"):E=!0));if(a.o.effect===p[2])for(f=0;f<a.aLen;f++)a._as[f].style.opacity=
"1";if(h<-U)a.o.effect!==p[0]&&a.o.effect!==p[1]||!E&&!a.o.inf||O(a,h),a.o.effect===p[2]&&(E||a.o.inf)&&O(a,1);else if(h>U)a.o.effect!==p[0]&&a.o.effect!==p[1]||!E&&!a.o.inf||K(a,h),a.o.effect===p[2]&&(E||a.o.inf)&&K(a,1);else{if(a.o.effect===p[0]||a.o.effect===p[1]){for(f=0;f<a.aLen;f++)a._as[f].style.transform="translate3d(0, 0, 0)";a.trk.style.transform=a.o.ver?"translate3d(0, ".concat(a.ct,"px, 0)"):"translate3d(".concat(a.ct,"px, 0, 0)")}if(a.o.effect===p[2])for(f=0;f<a.aLen;f++)a._as[f].style.opacity=
"1"}}l=q=w=B=h=0;e=!1}};a.o.swipe&&"sl"===d&&(a.eH.push(u(a.trk,"touchstart",function(f){V(f)})),a.eH.push(u(a.trk,"touchmove",function(f){W(f)})),a.eH.push(u(a.trk,"touchend",function(f){P(f)})),a.eH.push(u(a.trk,"mousedown",function(f){V(f)})),a.eH.push(u(a.trk,"mouseup",function(f){P(f)})),a.eH.push(u(a.trk,"mouseleave",function(f){P(f)})),a.eH.push(u(a.trk,"mousemove",function(f){W(f)})))},va=function(a){for(var d=0;d<a.bpall.length;d++)if(a.bpall[d].bpSLen=a.sLen,a.o.inf&&a.sLen>=a.bpall[d]._2Show){for(var b=
a.sLen-a.bpall[d]._2Show-Math.ceil(a.bpall[d].cntr/2);b<a.sLen;b++)if(a._ds[b]){var c=a._ds[b].cloneNode(!0);x(c,a.o.dupCls||"");a.bpall[d].bpSLen++;a.bpall[d].pDups.push(c)}for(b=0;b<a.bpall[d]._2Show+Math.ceil(a.bpall[d].cntr/2);b++)a._ds[b]&&(c=a._ds[b].cloneNode(!0),x(c,a.o.dupCls||""),a.bpall[d].bpSLen++,a.bpall[d].nDups.push(c))}b=function(e){var k=Math.floor(a.sLen/a.bpall[e]._2Scroll),g=a.sLen%a.bpall[e]._2Scroll,h=a.bpall[e]._2Show-a.bpall[e]._2Scroll;h>g&&k--;h<g&&k++;console.log("===core.bpall[i]",
a.bpall[e].nDups.length+a.bpall[e].pDups.length+a.sLen);console.log("==========pageLength",k);if(!a.o.inf&&a.sLen>a.bpall[e]._2Show){var l=[];a.bpall[e].dots=[];var q="";g=function(w){var B=null===document||void 0===document?void 0:document.createElement("li"),y=null===document||void 0===document?void 0:document.createElement("button");B.setAttribute("[data-carouzel-dot]".slice(1,-1),"");y.setAttribute("type","button");q='<div class="'.concat(a.o.dotNcls,'">').concat(w+1,"</div>");a.o.useTitle&&1===
a.bpall[e]._2Show&&a._ds[w].getAttribute("[data-carouzel-title]".slice(1,-1))&&(q+=a._ds[w].getAttribute("[data-carouzel-title]".slice(1,-1)),x(B,a.o.dotCls));y.innerHTML=q;B.appendChild(y);l.push(B);a.eH.push(u(y,"click",function(D){D.preventDefault();a.o.rtl?I(a,k-w-1):I(a,w)}));a.bpall[e].dots.push(l[w])};for(h=0;h<k;h++)g(h)}};for(d=0;d<a.bpall.length;d++)b(d)},wa=function(a){if(a.root)for(var d=a.root.querySelectorAll("img"),b=0;b<d.length;b++)a.eH.push(u(d[b],"dragstart",function(c){c.preventDefault()}))},
xa=function(a){try{for(var d=[],b=a.length;b--;)-1===d.indexOf(a[b].bp)&&d.push(a[b].bp);if(d.length===a.length)return{val:!0,bp:a.sort(function(c,e){return parseFloat(c.bp)-parseFloat(e.bp)})};console.error("Duplicate breakpoints found");return{}}catch(c){return console.error("Error parsing breakpoints"),{}}},ka=function(a){a=null===document||void 0===document?void 0:document.querySelectorAll(a);var d=a.length,b=[];if(0<d)for(var c=0;c<d;c++){var e=a[c].getAttribute("id");e&&r[e]&&b.push(r[e])}return b},
na=function(){return function(a,d,b){var c=__assign(__assign({},ea),b),e;"function"===typeof c.beforeInitFn&&c.beforeInitFn();b={};b.root=d;var k=c.slidesToScroll,g=c.slidesToShow,h=c.showArrows,l=c.showNavigation,q=c.appendUrlHash,w=c.activeClass,B=c.afterScrollFn,y=c.autoplay,D=c.autoplaySpeed,L=c.beforeScrollFn,M=c.centerBetween,E=c.disabledClass,U=c.dotTitleClass,V=c.dotIndexClass,W=c.duplicateClass,P=c.editModeClass,f=c.slideGutter,ya=c.hiddenClass,za=c.isInfinite,Aa=c.enableKeyboard,Ba=c.nextDirectionClass,
Ca=c.pauseOnHover,Da=c.previousDirectionClass,Ea=c.isRtl,Fa=c.animationSpeed,Ga=c.animationSpeed,Ha=c.enableTouchSwipe,Ia=c.touchThreshold,Ja=c.useTitlesAsDots,Ka=c.isVertical,La=c.verticalHeight;if(-1<p.indexOf(c.animationEffect))var la=c.animationEffect;else console.warn(oa),la=p[0];if(H[c.easingFunction])var ma=c.easingFunction;else console.warn(pa),ma=Object.keys(H)[0];k={_2Scroll:k,_2Show:g,_arrows:h,_nav:l,_urlH:q,activeCls:w,aFn:B,auto:y,autoS:D,bFn:L,cntr:M,disableCls:E,dotCls:U,dotNcls:V,
dupCls:W,editCls:P,gutr:f,hidCls:ya,inf:za,kb:Aa,nDirCls:Ba,pauseHov:Ca,pDirCls:Da,res:[],rtl:Ea,speed:Fa,startAt:Ga,swipe:Ha,threshold:Ia,useTitle:Ja,ver:Ka,verH:La,verP:1,effect:la,easeFn:ma};if(c.breakpoints&&0<c.breakpoints.length)for(g=0;g<c.breakpoints.length;g++)h={_2Scroll:c.breakpoints[g].slidesToScroll,_2Show:c.breakpoints[g].slidesToShow,_arrows:c.breakpoints[g].showArrows,_nav:c.breakpoints[g].showNavigation,bp:c.breakpoints[g].minWidth,bpSLen:0,cntr:c.breakpoints[g].centerBetween,dots:[],
gutr:c.breakpoints[g].slideGutter,nav:null,nDups:[],pDups:[],swipe:c.breakpoints[g].enableTouchSwipe,verH:c.breakpoints[g].verticalHeight,verP:1},k.res&&k.res.push(h);b.o=k;k=d.querySelectorAll("".concat("[data-carouzel-slide]"));b._ds=[];for(g=0;g<k.length;g++)b._ds.push(k[g]);b.arrowN=d.querySelector("".concat("[data-carouzel-nextarrow]"));b.arrowP=d.querySelector("".concat("[data-carouzel-previousarrow]"));b.bPause=d.querySelector("".concat("[data-carouzel-pause]"));b.bPlay=d.querySelector("".concat("[data-carouzel-play]"));
