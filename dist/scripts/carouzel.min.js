...
Math.ceil(a.bpall[d].cntr/2);b<a.sLen;b++)if(a._ds[b]){var c=a._ds[b].cloneNode(!0);x(c,a.o.dupCls||"");a.bpall[d].bpSLen++;a.bpall[d].pDups.push(c)}for(b=0;b<a.bpall[d]._2Show+Math.ceil(a.bpall[d].cntr/2);b++)a._ds[b]&&(c=a._ds[b].cloneNode(!0),x(c,a.o.dupCls||""),a.bpall[d].bpSLen++,a.bpall[d].nDups.push(c))}b=function(e){var h=Math.floor(a.sLen/a.bpall[e]._2Scroll);console.log("===core.sLen",a.sLen);console.log("===core.bpall[i]",a.bpall[e]);if(a.sLen>a.bpall[e]._2Show){var g=[],k=a.sLen%a.bpall[e]._2Scroll,
l=a.bpall[e]._2Show-a.bpall[e]._2Scroll;l>k&&h--;l<k&&h++;a.bpall[e].dots=[];var q="";k=function(w){var B=null===document||void 0===document?void 0:document.createElement("li"),y=null===document||void 0===document?void 0:document.createElement("button");B.setAttribute("[data-carouzel-dot]".slice(1,-1),"");y.setAttribute("type","button");q='<div class="'.concat(a.o.dotNcls,'">').concat(w+1,"</div>");a.o.useTitle&&1===a.bpall[e]._2Show&&a._ds[w].getAttribute("[data-carouzel-title]".slice(1,-1))&&(q+=
a._ds[w].getAttribute("[data-carouzel-title]".slice(1,-1)),x(B,a.o.dotCls));y.innerHTML=q;B.appendChild(y);g.push(B);a.eH.push(u(y,"click",function(D){D.preventDefault();a.o.rtl?I(a,h-w-1):I(a,w)}));a.bpall[e].dots.push(g[w])};for(l=0;l<h;l++)k(l)}};for(d=0;d<a.bpall.length;d++)b(d)},wa=function(a){if(a.root)for(var d=a.root.querySelectorAll("img"),b=0;b<d.length;b++)a.eH.push(u(d[b],"dragstart",function(c){c.preventDefault()}))},xa=function(a){try{for(var d=[],b=a.length;b--;)-1===d.indexOf(a[b].bp)&&
...
ea),b),e;"function"===typeof c.beforeInitFn&&c.beforeInitFn();b={};b.root=d;var h=c.slidesToScroll,g=c.slidesToShow,k=c.showArrows,l=c.showNavigation,q=c.appendUrlHash,w=c.activeClass,B=c.afterScrollFn,y=c.autoplay,D=c.autoplaySpeed,L=c.beforeScrollFn,M=c.centerBetween,E=c.disabledClass,U=c.dotTitleClass,V=c.dotIndexClass,W=c.duplicateClass,P=c.editModeClass,f=c.slideGutter,ya=c.hiddenClass,za=c.isInfinite,Aa=c.enableKeyboard,Ba=c.nextDirectionClass,Ca=c.pauseOnHover,Da=c.previousDirectionClass,Ea=
c.isRtl,Fa=c.animationSpeed,Ga=c.animationSpeed,Ha=c.enableTouchSwipe,Ia=c.touchThreshold,Ja=c.useTitlesAsDots,Ka=c.isVertical,La=c.verticalHeight;if(-1<p.indexOf(c.animationEffect))var la=c.animationEffect;else console.warn(oa),la=p[0];if(H[c.easingFunction])var ma=c.easingFunction;else console.warn(pa),ma=Object.keys(H)[0];h={_2Scroll:h,_2Show:g,_arrows:k,_nav:l,_urlH:q,activeCls:w,aFn:B,auto:y,autoS:D,bFn:L,cntr:M,disableCls:E,dotCls:U,dotNcls:V,dupCls:W,editCls:P,gutr:f,hidCls:ya,inf:za,kb:Aa,
nDirCls:Ba,pauseHov:Ca,pDirCls:Da,res:[],rtl:Ea,speed:Fa,startAt:Ga,swipe:Ha,threshold:Ia,useTitle:Ja,ver:Ka,verH:La,verP:1,effect:la,easeFn:ma};if(c.breakpoints&&0<c.breakpoints.length)for(g=0;g<c.breakpoints.length;g++)k={_2Scroll:c.breakpoints[g].slidesToScroll,_2Show:c.breakpoints[g].slidesToShow,_arrows:c.breakpoints[g].showArrows,_nav:c.breakpoints[g].showNavigation,bp:c.breakpoints[g].minWidth,bpSLen:0,cntr:c.breakpoints[g].centerBetween,dots:[],gutr:c.breakpoints[g].slideGutter,nav:null,nDups:[],
...
(new Date).getTime()+"_root_"+(n+1),e[n].setAttribute("id",k),new na(k,e[n],l))}}window&&0<Object.keys(r).length&&!ca&&(ca=!0,window.addEventListener("resize",ha,!1))}else"[data-carouzel-auto]"!==b&&console.error('init() "'.concat(b,'": ').concat("Element(s) with the provided query do(es) not exist"))};this.initGlobal=function(){d.init("[data-carouzel-auto]",{})};this.goToSlide=function(b,c){var e=ka(b);if(0<e.length)for(n=0;n<e.length;n++)-1!==da.indexOf(c)?c===da[0]?O(e[n],0):K(e[n],0):isNaN(parseInt(c,
10))||I(e[n],parseInt(c,10)-1);else console.error('goToSlide() "'.concat(b,'": ').concat("Element(s) with the provided query do(es) not exist"))};this.destroy=function(b){var c=ka(b);if(0<c.length){for(n=0;n<c.length;n++){var e=void 0;b=c[n];var h=null===(e=b.root)||void 0===e?void 0:e.getAttribute("id");e=b.root.querySelectorAll("*");for(var g=e.length-1;0<=g;g--){for(var k=b,l=e[g],q=k.eH.length;q--;)k.eH[q].element.isEqualNode&&k.eH[q].element.isEqualNode(l)&&(k.eH[q].remove(),k.eH.splice(q,1));
