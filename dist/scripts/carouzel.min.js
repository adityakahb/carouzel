...
function(a,d){console.log("==============before core.ci",a.ci);console.log("==============before core.pi",a.pi);a.pi=a.ci;a.ci+=a.bpo._2Scroll;console.log("==============then core.ci",a.ci);console.log("==============then core.pi",a.pi);a._t.id&&cancelAnimationFrame(a._t.id);a.o.inf&&(console.log("---------core.ci + core.bpo._2Show",a.ci+a.bpo._2Show>a.sLen),"undefined"===typeof a.pts[a.ci+a.bpo._2Show]?(a.pi-=a.sLen,a.ci=0):a.pi=a.ci-a.bpo._2Scroll);a.fLoad&&(a.fLoad=!1);S(a,d)},ra=function(a){if(a.root&&
a.o.kb){a.root.setAttribute("tabindex","-1");var d="";a.eH.push(u(a.root,"keydown",function(b){d=b.key.toLowerCase();switch(d){case "arrowleft":O(a,0);break;case "arrowright":K(a,0)}}))}},T=function(a,d){a&&a.bPause&&a.bPlay&&(d?(x(a.bPlay,a.o.hidCls),C(a.bPause,a.o.hidCls)):(x(a.bPause,a.o.hidCls),C(a.bPlay,a.o.hidCls)))},sa=function(a){a.root&&a.o.pauseHov&&(a.eH.push(u(a.root,"mouseenter",function(){a.paused=!0;T(a,!1);a._t.aId&&cancelAnimationFrame(a._t.aId)})),a.eH.push(u(a.root,"mouseleave",
function(){a.paused=!1;T(a,!0);ja(a)})));a.o.pauseHov||(a.paused=!1);a._t.aTotal=a.o.autoS},ja=function(a){var d=function(b){a._t.aElapsed=b-a._t.aStart;a._t.aProgress=a._t.aElapsed/a._t.aTotal;a._t.aProgress=1<a._t.aProgress?1:a._t.aProgress;a.paused||(1<=a._t.aProgress&&!X&&(a._t.aStart=N(),K(a,0)),a._t.aId=requestAnimationFrame(d))};a._t.aTotal+=a.o.speed;a.paused||(a._t.aStart=N(),a._t.aId=requestAnimationFrame(d))},ta=function(a){a.arrowP&&a.eH.push(u(a.arrowP,"click",function(d){d.preventDefault();
O(a,0)}));a.arrowN&&a.eH.push(u(a.arrowN,"click",function(d){d.preventDefault();K(a,0)}));a.o.inf&&a.bPause&&a.eH.push(u(a.bPause,"click",function(d){d.preventDefault();a.pauseClk=!0;T(a,!1)}));a.o.inf&&a.bPlay&&a.eH.push(u(a.bPlay,"click",function(d){d.preventDefault();a.pauseClk=!1;T(a,!0)}))},ua=function(a,d){var b=0,c=0,e=!1,h=0,g=0,k=0,l=0,q=0,w=0,B=0,y=0,D=0,L=0,M=0,E=!1,U=a.o.threshold||125,V=function(f){e=!0;"touchstart"===f.type?(L=f.changedTouches[0].screenX,M=f.changedTouches[0].screenY,
l=f.changedTouches[0].screenX,w=f.changedTouches[0].screenY):(L=f.clientX,M=f.clientY,l=f.clientX,w=f.clientY)},W=function(f){if(e){"touchmove"===f.type?(h=f.changedTouches[0].screenX,g=f.changedTouches[0].screenY,q=l-f.changedTouches[0].screenX,B=w-f.changedTouches[0].screenY):(h=f.clientX,g=f.clientY,q=l-f.clientX,B=w-f.clientY);b=h-L;c=g-M;y=Math.abs(b/c);D=Math.abs(c/b);a.ct||(a.ct=-a.pts[a.ci]);if(a.trk&&(a.o.effect===p[0]||a.o.effect===p[1])){if(y>D&&!a.o.ver&&(a.trk.style.transform="translate3d(".concat(a.ct-
...
"px, 0, 0)"):E=!0:0>(a.o.ver?c:b)&&(Math.abs(a.ct)+a.sWid*a.bpo._2Show>=a.sWid*a.aLen?a.trk.style.transform=a.o.ver?"translate3d(0, ".concat(a.ct,"px, 0)"):"translate3d(".concat(a.ct,"px, 0, 0)"):E=!0));if(a.o.effect===p[2])for(f=0;f<a.aLen;f++)a._as[f].style.opacity="1";if(k<-U)a.o.effect!==p[0]&&a.o.effect!==p[1]||!E&&!a.o.inf||O(a,k),a.o.effect===p[2]&&(E||a.o.inf)&&O(a,1);else if(k>U)a.o.effect!==p[0]&&a.o.effect!==p[1]||!E&&!a.o.inf||K(a,k),a.o.effect===p[2]&&(E||a.o.inf)&&K(a,1);else{if(a.o.effect===
...
a.eH.push(u(a.trk,"mouseup",function(f){P(f)})),a.eH.push(u(a.trk,"mouseleave",function(f){P(f)})),a.eH.push(u(a.trk,"mousemove",function(f){W(f)})))},va=function(a){for(var d=0;d<a.bpall.length;d++)if(a.bpall[d].bpSLen=a.sLen,a.o.inf&&a.sLen>a.bpall[d]._2Show){for(var b=a.sLen-a.bpall[d]._2Show-Math.ceil(a.bpall[d].cntr/2);b<a.sLen;b++)if(a._ds[b]){var c=a._ds[b].cloneNode(!0);x(c,a.o.dupCls||"");a.bpall[d].bpSLen++;a.bpall[d].pDups.push(c)}for(b=0;b<a.bpall[d]._2Show+Math.ceil(a.bpall[d].cntr/2);b++)a._ds[b]&&
...
a[c].getAttribute("id");e&&r[e]&&b.push(r[e])}return b},na=function(){return function(a,d,b){var c=__assign(__assign({},ea),b),e;"function"===typeof c.beforeInitFn&&c.beforeInitFn();b={};b.root=d;var h=c.slidesToScroll,g=c.slidesToShow,k=c.showArrows,l=c.showNavigation,q=c.appendUrlHash,w=c.activeClass,B=c.afterScrollFn,y=c.autoplay,D=c.autoplaySpeed,L=c.beforeScrollFn,M=c.centerBetween,E=c.disabledClass,U=c.dotTitleClass,V=c.dotIndexClass,W=c.duplicateClass,P=c.editModeClass,f=c.slideGutter,ya=c.hiddenClass,
za=c.isInfinite,Aa=c.enableKeyboard,Ba=c.nextDirectionClass,Ca=c.pauseOnHover,Da=c.previousDirectionClass,Ea=c.isRtl,Fa=c.animationSpeed,Ga=c.animationSpeed,Ha=c.enableTouchSwipe,Ia=c.touchThreshold,Ja=c.useTitlesAsDots,Ka=c.isVertical,La=c.verticalHeight;if(-1<p.indexOf(c.animationEffect))var la=c.animationEffect;else console.warn(oa),la=p[0];if(H[c.easingFunction])var ma=c.easingFunction;else console.warn(pa),ma=Object.keys(H)[0];h={_2Scroll:h,_2Show:g,_arrows:k,_nav:l,_urlH:q,activeCls:w,aFn:B,
auto:y,autoS:D,bFn:L,cntr:M,disableCls:E,dotCls:U,dotNcls:V,dupCls:W,editCls:P,gutr:f,hidCls:ya,inf:za,kb:Aa,nDirCls:Ba,pauseHov:Ca,pDirCls:Da,res:[],rtl:Ea,speed:Fa,startAt:Ga,swipe:Ha,threshold:Ia,useTitle:Ja,ver:Ka,verH:La,verP:1,effect:la,easeFn:ma};if(c.breakpoints&&0<c.breakpoints.length)for(g=0;g<c.breakpoints.length;g++)k={_2Scroll:c.breakpoints[g].slidesToScroll,_2Show:c.breakpoints[g].slidesToShow,_arrows:c.breakpoints[g].showArrows,_nav:c.breakpoints[g].showNavigation,bp:c.breakpoints[g].minWidth,
